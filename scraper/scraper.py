...
if __name__ == "__main__":
    ...
    scrape("software engineering co-op", "canada", 2, 3)
    ...
    scrape("data analyst intern", "canada", 2, 8)
    scrape("data science intern", "canada", 2, 10)
    scrape("data engineer intern", "canada", 2, 12)
    scrape("machine learning intern", "canada", 1, 14)
    scrape("AI intern", "canada", 1, 15)
    run()
    category_extractor()
